...
function saveTimer1(){
  ...
  lampu1OnTime = document.getElementById("onTime1").value;
  lampu1OffTime = document.getElementById("offTime1").value;

  localStorage.setItem("lampu1OnTime", lampu1OnTime);
  localStorage.setItem("lampu1OffTime", lampu1OffTime);
...
function saveTimer2(){
  ...
  lampu2OnTime = document.getElementById("onTime2").value;
  lampu2OffTime = document.getElementById("offTime2").value;

  localStorage.setItem("lampu2OnTime", lampu2OnTime);
  localStorage.setItem("lampu2OffTime", lampu2OffTime);
...
// =======================
// LOAD TIMER DARI STORAGE
// =======================

lampu1OnTime = localStorage.getItem("lampu1OnTime") || "";
lampu1OffTime = localStorage.getItem("lampu1OffTime") || "";

lampu2OnTime = localStorage.getItem("lampu2OnTime") || "";
lampu2OffTime = localStorage.getItem("lampu2OffTime") || "";

if(lampu1OnTime)
document.getElementById("onTime1").value = lampu1OnTime;

if(lampu1OffTime)
document.getElementById("offTime1").value = lampu1OffTime;

if(lampu2OnTime)
document.getElementById("onTime2").value = lampu2OnTime;

if(lampu2OffTime)
document.getElementById("offTime2").value = lampu2OffTime;
